...
public class KmqDemo {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            producer.send(topic, new KmqMessage(null, order),i);
        }
        Thread.sleep(500);
        ...
        while (true) {
            ...
            if(c > 20) {
                ...
                producer.send(topic, new KmqMessage(null, new Order(100000L + c, System.currentTimeMillis(), "USD2CNY", 6.52d)),index);
            }
            index ++;
            if( c == 'q' || c == 'e') break;
        }
